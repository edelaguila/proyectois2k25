...
namespace Interfac_V3
{
    public partial class FormModulos : Form
    {
        ...
        {
            btnSeguridad.BackColor = Color.FromArgb(210, 225, 255);  // Cambia el color de fondo al pasar el cursor
        }
        private void btnSeguridad_MouseLeave(object sender, EventArgs e)
        {
            btnSeguridad.BackColor = Color.FromArgb(177, 207, 235);  // Restaura el color original al quitar el cursor
        }
        ...
        {
            Btn_Logistica.BackColor = Color.FromArgb(210, 225, 255); // Cambia el color de fondo al pasar el cursor
        }
        private void Btn_Logistica_MouseLeave(object sender, EventArgs e)
        {
            Btn_Logistica.BackColor = Color.FromArgb(177, 207, 235); // Restaura el color original al quitar el cursor
        }
        ...
        {
            btnSalir.BackColor = Color.FromArgb(177, 207, 235);  // Restaura el color original al quitar el cursor
        }
    }
}